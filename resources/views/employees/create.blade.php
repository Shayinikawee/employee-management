    ...
    <form method="POST" action="{{ route('employees.store') }}">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-1">Unit / Department</label>
                    <select name="unit_id" class="w-full px-3 py-2 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 focus:border-amber-400 bg-white">
